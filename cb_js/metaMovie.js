(function(cmd, context) {
    ...
    return Promise.all([
        ...
        return context.mypim.query(
            `SELECT Id, Extension__c FROM Item__c WHERE Type__c = 'Movie' AND Id = '${escapedId}' LIMIT 1`
        ).then(itemResult => {
            ...
            return context.mypim.query(
                ...
                cmd.log('Probing: ' + movieUrl);
                const spawnResult = cp.spawnSync('python3', [ scriptPath, movieUrl, ], {
