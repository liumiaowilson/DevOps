...
`;
    ...
    return Promise.all([
        ...
        return (async () => {
            ...
            // 5. Scrape the poster URL + title from the pornhub watch page (age-gate cookies
            //    required, else the flashvars/og tags are absent).
            ...
            // Fall back to the viewkey only if the page exposes no title at all.
            ...
            // 9. Best-effort cleanup: remove the PHubQueueItem record we matched above.
